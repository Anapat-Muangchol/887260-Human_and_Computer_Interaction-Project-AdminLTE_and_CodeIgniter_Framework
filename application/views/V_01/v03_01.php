...
<div class="container">
    ...
    <a href="<?php echo site_url("home/v03_01"); ?>">
        <button type="button" class="btn btn-default pull-right active" style="margin-right: 35px;">ปีงบประมาณ</button>
    </a>
    <a href="<?php echo site_url("home/v02_01"); ?>">
        <button type="button" class="btn btn-default pull-right">ไตรมาส</button>
    </a>
