...
<div class="container">
    ...
    <a href="<?php echo site_url("home/v03_02"); ?>"><button type="button" class="btn btn-default pull-right" style="margin-right: 35px;">ไม่อนุมัติ</button></a>
    <a href="<?php echo site_url("home/v02_02"); ?>"><button type="button" class="btn btn-default pull-right">อนุมัติ</button></a>
    <a href="<?php echo site_url("home/v01_02"); ?>"><button type="button" class="btn btn-default pull-right active">รอการอนุมัติ</button></a>
</div>
<div class="container">
    <div class="row">
    ...
    <div class="row">
        <div class="col-sm-12" style="width: 97%;">
            ...
            <div class="box">
                ...
                <div class="box-body">
                    ...
                    <div id="submit" style="text-align: center; display: none;"><br><form><button type="submit" class="btn btn-default">ยืนยัน</button></form></div>
                </div>
            </div>
        ...
        <script type="text/javascript">
            ...
            $(function () {
                ...
                var time_report = [
                    {
                        "firstdate": "02/10/2558",
                        "lastdate": "05/10/2558",
                        "id": "57160183",
                        "name": "นุชนาฎ วงศ์วีระขันธ์",
                        "position": "นิสิต",
                        "type": "ลากิจ",
                        "becauses": "คนทางบ้านเสีย",
                        "approve": true},

                    {
                        "firstdate": "10/02/2559",
                        "lastdate": "11/02/2559",
                        "id": "57160423",
                        "name": "พีรพล รัตนโรจน์",
                        "position": "นิสิต",
                        "type": "ลาป่วย",
                        "becauses": "โรคกระเพราะ",
                        "approve": true},
                    ...
                    {
                        "firstdate": "05/01/2557",
                        "lastdate": "09/01/2557",
                        "id": "57160583",
                        "name": "ปภัสวรรณ คำทูม",
                        "position": "นิสิต",
                        "type": "ลาป่วย",
                        "becauses": "เป็นไข้หวัดใหญ่",
                        "approve": true},

                    {
                        "firstdate": "21/05/2558",
                        "lastdate": "25/05/2558",
                        "id": "57160603",
                        "name": "ศุภิณญา จันทร์เกตุ",
                        "position": "นิสิต",
                        "type": "ลาป่วย",
                        "becauses": "เป็นไข้เลือดออก",
                        "approve": true},

                    {
                        "firstdate": "22/05/2558",
                        "lastdate": "23/05/2558",
                        "id": "57160173",
                        "name": "เชาวนี สถิติถาพร",
                        "position": "อาจารย์",
                        "type": "ลากิจ",
                        "becauses": "ไปเยี่ยมญาติ",
                        "approve": true},

                    {
                        "firstdate": "02/05/2558",
                        "lastdate": "03/05/2558",
                        "id": "57160403",
                        "name": "จุฑารัตน์ จิตวิชยกุล",
                        "position": "อาจารย์",
                        "type": "ลากิจ",
                        "becauses": "ไปเยี่ยแม่",
                        "approve": true},
                    ...
                    {
                        "firstdate": "30/09/2557",
                        "lastdate": "01/10/2557",
                        "id": "57160413",
                        "name": "เทพพิทักษ์ พงศ์ประเสริฐ",
                        "position": "บุคลากร",
                        "type": "ลาป่วย",
                        "becauses": "ไม่สบาย",
                        "approve": true},
                    ...
                    {
                        "firstdate": "15/09/2558",
                        "lastdate": "16/07/2558",
                        "id": "57660073",
                        "name": "นายกิตติพศ ทันสมัย",
                        "position": "อาจารย์",
                        "type": "ลากิจ",
                        "becauses": "ทำบุญบ้าน",
                        "approve": true},
                ...
                for (var item = 0; item < time_report.length; item++) {
                    ...
                    if(time_report[item].approve)out+="<td><form><input id=\"radio\" type=\"radio\" name=\"approve\">อนมัติ&nbsp;<input id=\"radio\" type=\"radio\" name=\"approve\">ไม่อนมัติ</form></td></tr>";
                    else out+="<td><form><input id=\"radio\" type=\"radio\" name=\"approve\">อนมัติ&nbsp;<input id=\"radio\" type=\"radio\" name=\"approve\">ไม่อนมัติ</form></td></tr>";
                }
                $('#showTable').html(out);
