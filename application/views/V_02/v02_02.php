...
<div class="container">
    ...
    <a href="<?php echo site_url("home/v02_02"); ?>"><button type="button" class="btn btn-default pull-right active">อนุมัติ</button></a>
        ...
        <script type="text/javascript">
            ...
            $(function () {
                ...
                for (var item = 0; item < time_report.length; item++) {
                    ...
                    if(time_report[item].approve)out+="<td><form><input type=\"radio\" name=\"approve\" checked>อนมัติ&nbsp;<input id=\"radio\" type=\"radio\" name=\"approve\">ไม่อนมัติ</form></td></tr>";
                    else out+="<td><form><input type=\"radio\" name=\"approve\" checked >อนมัติ&nbsp;<input id=\"radio\" type=\"radio\" name=\"approve\">ไม่อนมัติ</form></td></tr>";
                }
                $('#showTable').html(out);
